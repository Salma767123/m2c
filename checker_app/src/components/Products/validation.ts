// Per-step validators for the Product Inspection form (checker app).
// Ported verbatim from the web QC portal:
//   frontend/src/components/Checker/Products/validation.ts
// Step IDs: generalInformation, productVerification, packagingInspection,
// defects, testing, review, documentation.

import { isTestOptional } from './PI_data';
