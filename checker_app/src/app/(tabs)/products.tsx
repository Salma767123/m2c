        ...
        <View className="flex-1 justify-end" style={{ backgroundColor: 'rgba(15,23,42,0.5)' }}>
          ...
          <View className="bg-white rounded-t-3xl" style={{ maxHeight: '85%' }}>
            ...
            >
              ...
              {/* Order status */}
              <Text className="text-sm font-bold text-slate-900 mb-2">Order status</Text>
              <View className="flex-row flex-wrap mb-5" style={{ columnGap: 8, rowGap: 8 }}>
              ...
              <View className="flex-row flex-wrap mb-2" style={{ columnGap: 8, rowGap: 8 }}>
