// Client mirror of backend/utils/inspectionSchedule.js.
//
...
// whole window has elapsed, it can no longer be started. Used by both the vendor
// (factory) inspection flow and the product inspection flow so the deadline rule
