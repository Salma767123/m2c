...
const fallbackSlides = [
  { id: '1', imageUrl: "/assets/images/hero/hs1.webp", altText: "Hero slide 1", displayOrder: 0 },
  { id: '2', imageUrl: "/assets/images/hero/hs2.webp", altText: "Hero slide 2", displayOrder: 1 },
  { id: '3', imageUrl: "/assets/images/hero/hs3.webp", altText: "Hero slide 3", displayOrder: 2 },
  { id: '4', imageUrl: "/assets/images/hero/hs4.webp", altText: "Hero slide 4", displayOrder: 3 },
];

export default function HeroSection() {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isAutoPlaying, setIsAutoPlaying] = useState(true);
  const [slides, setSlides] = useState<Pick<BannerImage, 'id' | 'imageUrl' | 'altText' | 'displayOrder'>[]>(fallbackSlides);
  ...
  return (
    ...
    >
      <div className="relative w-full h-[250px] sm:h-[300px] md:h-[450px] lg:h-[550px] xl:h-[650px] 2xl:h-[750px]">
