...
export default function FeaturedProducts() {
  ...
  if (isLoading) {
    ...
    return (
      <section className="bg-white py-6 sm:py-8 lg:py-10 font-sans">
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-[#faf9f7] via-white to-[#fdf6f6] py-6 sm:py-8 lg:py-10 font-sans">
      <SectionBackdrop />
