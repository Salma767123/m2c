                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateItem(item.id, "totalQuantity", e.target.value === '' ? 0 : parseFloat(e.target.value))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateItem(item.id, "inspectionQuantity", e.target.value === '' ? 0 : parseFloat(e.target.value))}
