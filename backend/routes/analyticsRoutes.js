...
router.get("/page-analytics", authenticateToken, requireAdminRole, requirePermission('analytics:view'), getPageAnalytics);
router.get("/product-heatmap", authenticateToken, requireAdminRole, requirePermission('analytics:view'), getProductHeatMap);
