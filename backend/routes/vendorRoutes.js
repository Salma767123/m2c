...
router.put('/:vendorId/approve', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), approveVendor);
router.put('/:vendorId/confirm-approval', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), confirmApproval);
router.put('/:vendorId/cancel-approval', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), cancelApproval);
router.put('/:vendorId/reject', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), rejectVendor);
router.put('/:vendorId/confirm-rejection', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), confirmRejection);
router.put('/:vendorId/cancel-rejection', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), cancelRejection);
router.put('/:vendorId/suspend', authenticateToken, requireRole('admin'), requirePermission('vendor_management:edit'), suspendVendor);
