...
const STATUS_WEIGHT = {
    ORDER_CREATED: 0,
    ACCEPTED_BY_VENDOR: 1,
    VENDOR_PROCESSING: 2,
    PACKED_BY_VENDOR: 3,
    IN_TRANSIT_TO_ADMIN_HUB: 4,
    RECEIVED_AT_ADMIN_HUB: 5,
    APPROVED_BY_ADMIN_HUB: 6,
    REJECTED_BY_ADMIN_HUB: 6, // same tier as approved — needs resolution
    SHIPPED_TO_CUSTOMER: 7,
    DELIVERED: 8,
    CANCELLED: -1,
    RETURNED: -2,
};
