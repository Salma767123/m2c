            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="background-color:#111827;padding:40px 40px 32px;text-align:center;">
                  ...
                  <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:700;letter-spacing:-0.5px;">Welcome to the Admin Portal!</h1>
                  <p style="margin:8px 0 0;color:#9ca3af;font-size:14px;">Your Staff account has been created</p>
                </td>
              </tr>
                    ...
                    <tr>
                      <td style="padding:24px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="padding:8px 0;">
                              <span style="color:#64748b;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Email ID</span>
                              <div style="margin-top:4px;padding:12px 16px;background-color:#ffffff;border:1px solid #e2e8f0;border-radius:8px;">
                                <span style="color:#0f172a;font-size:18px;font-weight:700;font-family:'Courier New',monospace;letter-spacing:1px;">${email}</span>
                              </div>
                            </td>
                          </tr>
                          <tr>
...
/**
 * Send a test email — used by QC checkers during vendor inspection to
 * confirm a vendor's email address is real and reachable. No links or
 * actions; the vendor only needs to receive it.
 */
const sendTestEmail = async ({ to, checkerName, vendorName }) => {
  const transporter = createTransporter();
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="background-color:#111827;padding:32px 40px;text-align:center;">
                  <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.5px;">Email Verification Test</h1>
                  <p style="margin:8px 0 0;color:#9ca3af;font-size:14px;">M2C MarkDowns — Quality Control</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding:32px 40px;">
                  <p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6;">
                    This is a test email sent as part of the vendor verification process${vendorName ? ` for <strong>${vendorName}</strong>` : ''}.
                  </p>
                  <p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6;">
                    ${checkerName ? `Quality checker <strong>${checkerName}</strong> is` : 'Our quality team is'} confirming that this email address is active and reachable.
                  </p>
